...
def writeExcel(missionID, datapool, ascent, descent):
    ...
    labels = ['Mission ID','Local Time','Longitude','Latitude', 'Altitude','Pressure','Temperature','Temperature2', 'Humidity', 'Altitude-corr', 'Vertical velocity','Horizontal Velocity', 'Horizontal Direction']
